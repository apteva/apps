...
Independent Apteva sidecar app, version 0.4.3. SQLite and Pebble implement one local record API. The app owns its files and does not change CRM, Tables, or other apps' databases.
