...
func TestLifecycleManifestDeclarationsMatchDisk(t *testing.T) {
	...
	want := []string{
		"telephony.routing.requested",
		"telephony.routing.accepted",
		...
		"telephony.routing.offer.expired",
		"telephony.routing.offer.canceled",
		"telephony.routing.destination.connected",
		"telephony.routing.destination.connection_failed",
		"telephony.routing.call.completed",
		"telephony.routing.call.failed",
