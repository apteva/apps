...
export const AUDIO_SETTINGS_KEY = "apteva.telephony.softphone.audio.v3";
export const PREVIOUS_AUDIO_SETTINGS_KEY = "apteva.telephony.softphone.audio.v2";
...
export function resolveAudioOptions(
  ...
  try {
    ...
    if (previous) return { ...DEFAULT_SOFTPHONE_AUDIO_OPTIONS, ...previous, autoGainControl: false };
