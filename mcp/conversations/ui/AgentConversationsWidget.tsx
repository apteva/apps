...
export default function AgentConversationsWidget(props: AgentConversationsWidgetProps) {
  ...
  return <PageContextProvider.Provider value={props.pageContext}><DashboardConversations projectId={props.projectId} installId={props.installId} locale={props.locale} timeZone={props.timeZone} messages={props.messages} composer={{...props.composer,layout:props.composer?.layout ?? props.widgetSettings?.composer_layout ?? "auto"}}><Widget {...props}/></DashboardConversations></PageContextProvider.Provider>;
}
