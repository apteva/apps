...
export default function ConversationsPanel(props: NativePanelProps) {
  ...
  return <DashboardConversations projectId={props.projectId} installId={props.installId} locale={props.locale} timeZone={props.timeZone} messages={props.messages}><Panel {...props}/></DashboardConversations>;
}
