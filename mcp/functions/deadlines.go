...
func extractErrorCode(message string) string {
	for _, code := range []string{"worker_oom", "worker_memory_limit", "protocol_memory_limit", "protocol_host_memory_pressure", "integration_timeout", "app_call_timeout", "invocation_timeout", "caller_canceled", "upstream_timeout", "nested_capacity_exhausted", "nested_cycle", "nested_depth_limit", "memory_budget_exhausted", "worker_limit", "function_worker_limit", "queue_limit", "function_queue_limit", "nested_downstream_limit"} {
