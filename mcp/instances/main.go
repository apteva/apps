...
requires:
  permissions:
    ...
    - net.egress
    - platform.apps.call
    - platform.connections.manage_owned_credentials
...
provides:
  ...
  mcp_tools:
    ...
    - { name: object_storage_create, description: "Provision and configure private S3 storage, CORS, and a managed connection; resume with id." }
