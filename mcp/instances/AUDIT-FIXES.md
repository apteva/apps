# Instances 0.4.41 audit fixes

Unreleased patch based on `instances/v0.4.41` (`941615e106bbad834ee2c58f5259d8e7da317d5d`). Release manifests remain at 0.4.41 until a release is tagged. No production deployment or cloud resource mutation was performed while developing this patch.
...
| 12 | Build with Go 1.27.1 and x/crypto 0.56.0. Update the SDK from v0.71.0 to v0.73.0, verified as its descendant at the local SDK HEAD. |
