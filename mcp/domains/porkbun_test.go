...
func TestPorkbunRecordUnchanged(t *testing.T) {
	base := DNSRecord{Type: "CNAME", Value: "v.dkim.amazonses.com", TTL: 1800, Prio: 0}
	...
	cases := []struct {
		...
		{"prio differs", DNSRecord{Type: "CNAME", Value: "mx.example.com", TTL: 1800, Prio: 10}, "mx.example.com", 1800, 20, false},
		{"value case + whitespace insensitive", DNSRecord{Type: "CNAME", Value: " V.DKIM.amazonSES.com ", TTL: 1800}, "v.dkim.amazonses.com", 1800, 0, true},
	}
