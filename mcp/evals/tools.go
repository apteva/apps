...
func (a *App) MCPTools() []sdk.Tool {
	return []sdk.Tool{
		...
		{Name: "eval_suite_create", Description: "Create an evaluation suite.", InputSchema: requiredSchema("name"), Handler: a.toolSaveSuite(true)},
		...
		{Name: "eval_case_create", Description: "Add a behavioral case to a suite.", InputSchema: requiredSchema("suite_id", "name", "prompt"), Handler: a.toolSaveCase(true)},
		...
		{Name: "eval_experiment_create", Description: "Queue a suite against agent/model targets.", InputSchema: requiredSchema("suite_id"), Handler: a.toolCreateExperiment},
...
func (a *App) toolSaveSuite(creating bool) sdk.ToolHandler {
	return func(_ *sdk.AppCtx, args map[string]any) (any, error) {
		var item Suite
		if err := decodeArgs(args, &item); err != nil {
			return nil, err
		}
