import{useCallback as c,useEffect as _,useState as u}from"react";import{jsx as t,jsxs as r}from"react/jsx-runtime";var b="/api/apps/push",C={provider_ready:!1,active_devices:0,sent_today:0,failed_today:0,recent:[]};function $({projectId:s=""}){let[a,o]=u(C),[h,w]=u([]),[m,v]=u(!0),[f,n]=u(""),p=c((e)=>{if(!s)return`${b}${e}`;let i=e.includes("?")?"&":"?";return`${b}${e}${i}project_id=${encodeURIComponent(s)}`},[s]),d=c(async()=>{v(!0);try{let[e,i]=await Promise.all([fetch(p("/stats"),{credentials:"same-origin"}),fetch(p("/devices?limit=20"),{credentials:"same-origin"})]);if(!e.ok||!i.ok)throw Error(`Push returned ${e.ok?i.status:e.status}`);o(await e.json());let g=await i.json();w(g.devices||[]),n("")}catch(e){n(e instanceof Error?e.message:"Could not load Push")}finally{v(!1)}},[p]);_(()=>{d()},[d]);let N=c(async(e)=>{n("Sending test…");let i=await fetch(p(`/admin/devices/${encodeURIComponent(e)}/test`),{method:"POST",credentials:"same-origin"});if(!i.ok){let g=await i.json().catch(()=>({}));n(g.error||`Test failed (${i.status})`);return}n("Test notification sent"),await d()},[p,d]),k=c(async(e)=>{let i=await fetch(p(`/admin/devices/${encodeURIComponent(e)}`),{method:"DELETE",credentials:"same-origin"});if(!i.ok){n(`Could not revoke device (${i.status})`);return}n("Device revoked"),await d()},[p,d]);return r("div",{className:"push-panel",children:[t("style",{children:D}),r("header",{className:"push-header",children:[r("div",{children:[t("div",{className:"push-eyebrow",children:"MOBILE DELIVERY"}),t("h1",{children:"Push"}),t("p",{children:"Private notifications for connected Apteva devices."})]}),t("button",{className:"push-refresh",onClick:d,disabled:m,children:m?"Loading…":"Refresh"})]}),r("section",{className:"push-metrics","aria-label":"Push status",children:[t(l,{label:"APNs",value:a.provider_ready?"Connected":"Not connected",tone:a.provider_ready?"good":"muted"}),t(l,{label:"Active devices",value:String(a.active_devices)}),t(l,{label:"Sent today",value:String(a.sent_today)}),t(l,{label:"Failed today",value:String(a.failed_today),tone:a.failed_today?"warn":"muted"})]}),f&&t("div",{className:"push-message",role:"status",children:f}),r("div",{className:"push-grid",children:[r("section",{className:"push-card",children:[r("div",{className:"push-card-heading",children:[r("div",{children:[t("h2",{children:"Devices"}),t("p",{children:"iPhones registered with this relay."})]}),t("span",{className:"push-count",children:h.length})]}),r("div",{className:"push-list",children:[h.length===0&&t(y,{title:"No devices yet",detail:"A device appears here after the iOS app enables notifications."}),h.map((e)=>r("div",{className:"push-device",children:[t("div",{className:"push-device-icon","aria-hidden":"true",children:t("span",{})}),r("div",{className:"push-device-copy",children:[t("strong",{children:e.user_ref||"Apteva for iPhone"}),r("span",{children:[e.app_version?`v${e.app_version} · `:"",x(e.last_seen_at)]})]}),t("span",{className:`push-status ${e.status}`,children:e.status}),e.status==="active"&&r("div",{className:"push-actions",children:[t("button",{onClick:()=>N(e.id),children:"Test"}),t("button",{className:"danger",onClick:()=>k(e.id),children:"Revoke"})]})]},e.id))]})]}),r("section",{className:"push-card",children:[t("div",{className:"push-card-heading",children:r("div",{children:[t("h2",{children:"Recent delivery"}),t("p",{children:"Latest messages accepted or rejected by APNs."})]})}),r("div",{className:"push-list",children:[a.recent.length===0&&t(y,{title:"Nothing sent yet",detail:"Delivery history will appear here."}),a.recent.map((e)=>r("div",{className:"push-delivery",children:[t("div",{className:`push-dot ${e.status}`}),r("div",{className:"push-delivery-copy",children:[t("strong",{children:P(e.type)}),t("span",{children:x(e.created_at)}),e.error&&t("small",{title:e.error,children:e.error})]}),t("span",{className:`push-status ${e.status}`,children:e.status})]},e.id))]})]})]})]})}function l({label:s,value:a,tone:o=""}){return r("div",{className:`push-metric ${o}`,children:[t("span",{children:s}),t("strong",{children:a})]})}function y({title:s,detail:a}){return r("div",{className:"push-empty",children:[t("strong",{children:s}),t("span",{children:a})]})}function P(s){if(s==="approval")return"Approval";if(s==="alert")return"Alert";if(s==="report")return"Report";return"Test notification"}function x(s){let a=new Date(s);if(Number.isNaN(a.getTime()))return"Recently";let o=Math.max(0,Math.floor((Date.now()-a.getTime())/1000));if(o<60)return"Just now";if(o<3600)return`${Math.floor(o/60)}m ago`;if(o<86400)return`${Math.floor(o/3600)}h ago`;return`${Math.floor(o/86400)}d ago`}var D=`
  .push-panel {
    --push-orange: #ff6b1a;
...
//# debugId=F13BA9116A6AAD1564756E2164756E21
