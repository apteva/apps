import OutputPresets from "../../composer/ui/output-presets";
...
export default function PersonaPanel({ projectId }) {
 ...
 h(PersonaCompositionOutputCard,{composition:c,projectId}),
...
function PersonaCompositionOutputCard({composition,projectId}){
 const [open,setOpen]=useState(false);
 return h("details",{className:"border border-border rounded p-3",onToggle:e=>setOpen(e.currentTarget.open)},
 h("summary",{className:"text-sm cursor-pointer"},"Song · Image video · Full clip"),
 open && composition.composer_composition_id && h(OutputPresets,{compositionId:composition.composer_composition_id,projectId,songLabels:true}));
}
