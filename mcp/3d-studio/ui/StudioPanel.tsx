    ...
    <div className="s3">
      ...
      <header className="s3-header">
        <div className="s3-brand">
          <img className="s3-logo" src={`${uiBase}/icon.svg`} alt="3D Studio" />
          <div>
