...
// Exact substitutions only: edit-distance guesses create false positives for
// legitimate company domains. These are common consumer-provider typos where
// the intended destination is unambiguous enough to offer as a suggestion.
