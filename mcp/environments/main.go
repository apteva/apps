...
version: 0.2.1
description: Isolated test environments with project apps, fake connections, deterministic seeds, agents, web fixtures, edge policies, and snapshots.
author: Apteva
...
runtime:
  kind: source
  source: { repo: github.com/apteva/apps, ref: environments/v0.2.1, entry: mcp/environments }
  port: 8080
  health_check: /health
