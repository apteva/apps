...
runtime:
  kind: source
  source: { repo: github.com/apteva/apps, ref: environments/v0.1.0, entry: mcp/environments }
  port: 8080
  health_check: /health
