...
runtime:
  kind: source
  source: { repo: github.com/apteva/apps, ref: environments/v0.7.2, entry: mcp/environments }
  port: 8080
  health_check: /health
