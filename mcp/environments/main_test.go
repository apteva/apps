...
func testStore(t *testing.T) store {
	...
	for _, name := range []string{"001_init.sql", "002_web_fixtures.sql", "003_single_active_run.sql", "004_voice_calls.sql", "005_protocol_fixtures.sql", "006_history_indexes.sql", "007_reconcile_state.sql"} {
